...
lot of output. Daemons and other programs without a terminal or other interface
especially benifit from the use of loggin, as its about the only way they can
output information. Usually logging happens at several levels, for example
