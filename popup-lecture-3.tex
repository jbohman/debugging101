...
\begin{itemize}
    \item Gprof - the GNU Profiler. A popular profiler among Unix developer. Works for any 
          language supported by GCC (the GNU Compiler Collection).
    \item java -Xprof - Java's built-in profiler. Not very extensive, but very easy to use. 
