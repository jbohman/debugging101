...
\begin{itemize} 
    ...
    \item Only work with one code change at a time. If you change more than one
          thing you might not know what you changed that fixed or introduced a bug.
    ...
    \item Refactor the code, even though your code always should be nicely
