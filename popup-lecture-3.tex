...
result of this in a table after finished execution. This shows the programmer which methods or functions are time bottle necks, and need to be optimized.

\subsection{Popular profilers}
There is many good profilers available, but here we list the most popular ones.
\begin{itemize}
    \item \textbf{Gprof} The GNU Profiler. A popular profiler among Unix developer. Works for any 
          language supported by GCC (the GNU Compiler Collection).
    \item \textbf{java -Xprof} Java's built-in profiler. Not very extensive, but very easy to use. 
          Simply run the java program with the -Xprof flag.
\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
