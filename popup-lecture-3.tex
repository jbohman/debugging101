...
used by any developer. When doing manual testing the developer or a another
...
doing it. A developer most certainly have preconceptions of his or hers code
...
test find a bug and it is fixed, how can the developer make sure that the fix
did not break earlier manual tests? The only way is to run those tests again,
and now you enter a declining spiral.
...
of code that can be tested in your program. Libraries for unit testing is
available in almost any programming language and platform.
...
\noindent{It} should be mentioned that there is always a good idea to know the
